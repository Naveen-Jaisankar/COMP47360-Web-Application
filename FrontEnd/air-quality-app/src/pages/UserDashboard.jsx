// On this branch User Dashboard is simply a testing stage for Matas'graph -JM
...
const UserDashboard = () => {
    ...
    const fakeID = 1
    const handleClick = () => {
        axiosInstance.get(`/api/dailyquizscores/${fakeID}`)
    ...
    return(
    <>
        <Typography>DASLKDJF;LAKSDJF;LKAJSDLFKJASKLDJFLKAJSDLKFJLAS</Typography>
        <div>
