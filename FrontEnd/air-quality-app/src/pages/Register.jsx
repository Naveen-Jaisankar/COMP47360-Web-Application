...
const Register = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
        <Typography variant="h4" className="mb-3 font-bold">{constants.register.title}</Typography>
        <Typography variant="body1" className="mb-6 text-gray-500">{constants.register.body}</Typography>
